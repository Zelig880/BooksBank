<template>
  <div class="grid grid-cols-1 md:grid-cols-5 gap-5 bg-white py-8 mx-10 border-b-2">
    <div class="col-span-1 mb-3">
      <img class="m-auto" :src="thumbnail" :alt="`Cover for ${title}`">
    </div>
