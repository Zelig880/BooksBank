<template>
  <div class="privacy container mx-auto">
    <h2 class="text-3xl font-bold mb-6">Privacy Policy for Booksbank.co.uk</h2>
    <p>
      At BooksBank, accessible from Booksbank.co.uk, one of our main priorities
      is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by BooksBank and how
      we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in BooksBank. This policy is not applicable to any
    ...
    <p>
      BooksBank follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, BooksBank uses 'cookies'. These cookies are used
    ...
    <P>You may consult this list to find the Privacy Policy for each of the
      advertising partners of BooksBank.</P>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on BooksBank, which are sent directly
    ...
    <p>
      Note that BooksBank has no access to or control over these cookies that
    ...
    <p>
      BooksBank's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      BooksBank does not knowingly collect any Personal Identifiable Information
...
export default {
  metaInfo () {
    return { title: this.$t('privacyPolicy') }
  }
}
</script>
