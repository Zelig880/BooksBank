<template>
  <div class="privacy container mx-auto">
    <h2 class="text-3xl font-bold mb-6">Terms and Conditions</h2>

    <p>Welcome to BooksBank!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of BooksBank's Website, located at Booksbank.co.uk.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use BooksBank if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing BooksBank, you agreed to use
      cookies in agreement with the BooksBank's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, BooksBank and/or its licensors own the
      intellectual property rights for all material on BooksBank. All
      intellectual property rights are reserved. You may access this from
      BooksBank for your own personal use subjected to restrictions set in these
    ...
    <ul class="list-disc pl-5">
      ...
      <li>Redistribute content from BooksBank</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. BooksBank does
      ...
      BooksBank,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, BooksBank shall not be liable for the
    ...
    <p>
      BooksBank reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant BooksBank a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of BooksBank; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to BooksBank. Please include your name, your organization name,
    ...
    <p>
      No use of BooksBank's logo or other artwork will be allowed for linking
